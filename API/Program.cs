...
static void AddTestData(SqlServerContext context)
{
    ...
    var flat = new Property("house", "a274", RentCategory.Rent, PropertyType.Flat, 370);
    otavio.Add(flat);

    var appartment = new Property("appartment", "d15a274", RentCategory.Rent, PropertyType.Appartment, 590);
